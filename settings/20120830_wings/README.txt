protocol 20120830_wings:

This protocol is just for debugging wing tracking. 

changed trxfilestr to wingtracking_results.mat
changed ctraxresultsavifilestr to wingtrx_results_movie
modified MakeCtraxResultsMovie to plot wings. 
modified MakeCtraxResultsMovie to use a temporary avi file in bransonlab. 
